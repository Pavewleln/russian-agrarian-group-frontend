import {ICreateOrderResponseStatusAdmin, IOrder} from "../../../services/order/order.interface";
...
export const CreateOrderPopupStatusAdmin: FC<IPopup> = ({showModal, setShowModal, addOrder}) => {
    const {user} = useAuth()
    const closeModal = () => {
        setShowModal(false)
        reset({
